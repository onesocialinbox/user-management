				...
				<?php $form = ActiveForm::begin([
					...
					<div class="login-footer">	 
						<ul class="recovery-links">
							<li><font size="20px"> <?= GhostHtml::a(UserManagementModule::t('front', "Verify Otp"), ['/user/userotpverification']) ?></font></li>

							<li> <font size="20px"><?= Html::a('Login Instructions', Url::to('@web/instructions.pdf'),['target'=>'_blank']) ?></font></li>

							<li> <font size="20px">  <?= Html::a('Rules', Url::to('@web/Rules.pdf'),['target'=>'_blank'])?></font></li>

							<li> <font size="20px"><?=Html::a('Contact Us', Url::to('@web/contact.txt'),['target'=>'_blank'])?></font></li>
